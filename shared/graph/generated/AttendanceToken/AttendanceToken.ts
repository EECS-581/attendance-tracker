...
export class AttendanceToken extends ethereum.SmartContract {
  static bind(address: Address): AttendanceToken {
    return new AttendanceToken("AttendanceToken", address);
  }
