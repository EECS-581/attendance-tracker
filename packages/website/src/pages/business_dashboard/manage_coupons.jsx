    ...
    <main className="w-full overflow-hidden">
      ...
      <div className="container mx-auto mt-6 px-4">
          ...
          <div className="flex space-x-4 mb-4">
            {/* creates the Add new class button, this will need to be updated once we have CRUD functionality - maybe turn into a modal? */}
            ...
            <li key={index} className="bg-white p-4 shadow-md rounded-md">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="space-x-2">
                  {/* create a button for updating the coupon  */}
                  <LightColorfulButton
                    shadowColor="#D1CDC7"
                    title="Update"
                    link="/"
                  />
                  {/* create a button for deleting the coupon  */}
                  <LightColorfulButton
                    shadowColor="#D1CDC7"
                    title="Delete"
                    link="/"
